    ...
    handler: () => {
      ...
      handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-regulation-of-t7-gp2-5-binding-dynamics",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-watching-dna-polymerase-displaces-ssb-in-real-time",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6C%6F%6E%67%66%75%32.%78%75@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/longfuxu", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/longfu_xu", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=lkZwOH0AAAAJ", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0003-0074-3106", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
